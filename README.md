...
- [x] Add a paragraph of text (50 words at least) as the Joh Doe's bio. You can use random text for the paragraph content.
...
- [x] Add Discord as a service and discord's real username as a value to the table.
- [x] Add LinkedIn as a service and linkedIn's real username as a value to the table. Make the value to be a link to your LinkedIn profile page opened in a new tab.
